...
//스탯업 부분
void StatUpStatus(string name, int stat[], int& HP_Potion, int& MP_Potion, int& pow_inc, int& def_inc, bool& isGameStart)
{
...
// 소멸자 본문 (비워두더라도 반드시 껍데기는 있어야 합니다!)
Player::~Player() {
}
...
void Player::setMp(int _mp) { mp = _mp; }
